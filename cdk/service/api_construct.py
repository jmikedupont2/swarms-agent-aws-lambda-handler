...
class CreateAgentApiStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        swarms_lambda = _lambda.DockerImageFunction(
            self, "swarmsAgent",
            code=_lambda.DockerImageCode.from_image_asset("./create_agent_api/lambdas/swarms"),
            memory_size=1024 * 8,
            timeout=Duration.seconds(90),
            architecture=_lambda.Architecture.X86_64,
            environment={
        ...
        api = apigw.RestApi(
            self, "AgentApi",
            rest_api_name="Agent Service API",
            description="API for the AI Agent service"
        )
